                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <img src="{{asset('uploads/banners/'.$bannerDetail->image)}}" alt=""
                                                style="width:250px;">
                                            @endif
                                        </td>
                                        <td>
                                            <input type="checkbox" class="BannerStatus btn btn-success"
                                                rel="{{$bannerDetail->id}}" data-toggle="toggle" data-on="Enabled"
                                        ...
                                        <td>
                                            <a href="{{url('/admin/edit-banner/'.$bannerDetail->id)}}"
                                                class="btn btn-add btn-sm"><i class="fa fa-pencil"></i></a>
                                            <a href="{{url('/admin/delete-banner/'.$bannerDetail->id)}}"
